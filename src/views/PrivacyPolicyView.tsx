        ...
        <div className="space-y-8 text-sm sm:text-base text-gray-300 leading-relaxed font-['Inter']">
          ...
          <section className="space-y-3 p-5 sm:p-6 rounded-2xl bg-white/[0.02] border border-white/5">
            ...
            <p className="text-sm text-gray-400">
              If a parent or guardian believes that Game Vault Forum has in its database the personal information of a child under 13, please contact us immediately at <span className="text-purple-300 font-mono">contact@gamevault.forum</span>, and we will utilize our best efforts to promptly remove such information from our records.
            </p>
          </section>
