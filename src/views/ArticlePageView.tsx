    ...
    <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-8 animate-in fade-in duration-300">
      ...
      <section className="p-6 sm:p-8 rounded-3xl bg-[#0c0e18] border border-white/10 shadow-2xl space-y-6">
        <div className="flex items-center justify-between border-b border-white/10 pb-4">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-xl font-bold font-['Rajdhani'] uppercase tracking-wider text-white">
              Discussion & Comments ({sortedComments.length})
            </h3>
          </div>
          <span className="text-xs text-gray-400 font-mono">
            {isSignedIn ? 'Signed in as ' + currentUser.name : 'Sign in to interact'}
          </span>
        </div>
        ...
        {!isSignedIn ? (
          <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-purple-950/40 via-purple-900/20 to-black border border-purple-500/30 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xl">
            <div className="space-y-1">
              ...
              <p className="text-xs sm:text-sm text-gray-300 leading-relaxed">
                Visitors can interact with content across Game Vault only when registered and signed in. Join the community to post comments, discuss with operatives, and share your tactical perspectives.
              </p>
            </div>
            <button
              type="button"
          ...
          /* Comment Form for signed-in operatives */
